...
public class EnforcementZoneCentreResource {
    ...
    public Response findEnforcementZoneCentreById(@PathParam("id") Short enforcementZoneCentreId) {
        EnforcementZoneCentre existingEnforcementZoneCentre = _enforcementZoneCentreRepository.findById(enforcementZoneCentreId).orElseThrow(NotFoundException::new);
